      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Organize content into categories</p>
          </div>
            ...
            <TableBody>
              {isLoading ? (
                ...
                <TableRow key={cat.id} className="border-border hover:bg-secondary/30">
                  ...
                  <TableCell className="text-gray-300">{new Date(cat.createdAt).toLocaleDateString()}</TableCell>
